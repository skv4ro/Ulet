...
public class LoginView extends Dialog {
    ...
    public LoginView() {
        ...
        setIconImage(R.getImage("login.png"));
    ...
    public void addLoginListener(ActionListener controller) {
    ...
    public void addRememberListener(ActionListener controller) {
        rememberPasswordCheckBox.addActionListener(controller);
    }

    public void addUsernameListener(FocusListener controller) {
